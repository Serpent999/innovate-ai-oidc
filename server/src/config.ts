...
export class Config {
    debugLogging = 'debug';
    'server.port' = '8081';
    'jhipster.clientApp.name' = 'innovate_ai_oidc';
    ...
    'jhipster.mail.from' = 'innovate_ai_oidc@localhost';
    'jhipster.swagger.default-include-pattern' = '/api/.*';
    'jhipster.swagger.title' = 'innovate_ai_oidc API';
    'jhipster.swagger.description' = 'innovate_ai_oidc API documentation';
    ...
    'eureka.instance.appname' = 'innovate_ai_oidc';
    'eureka.instance.instanceId' = 'innovate_ai_oidc:${random.value}';
    ...
    'cloud.config.name' = 'innovate_ai_oidc';
